...
<template>
  <div class="mx-auto max-w-7xl px-6 py-24">
    <div class="flex items-baseline gap-6">
      ...
      <a
        href="https://www.instagram.com/legongsorcier/"
        target="_blank"
        rel="noopener noreferrer"
        class="flex items-center gap-1.5 text-sm tracking-wider text-stone-400 uppercase transition-colors hover:text-stone-100"
      >
